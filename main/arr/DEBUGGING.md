...
This file exists with the purpose of helping you debug your issues with `arr`. This is not a foolproof file, it may miss certain issues and steps.

## Debugging steps

To debug any issues with `arr` use the following steps:
...
{"port":XXXXX,.................}
```
Where `XXXXX` is your forwarded port.
