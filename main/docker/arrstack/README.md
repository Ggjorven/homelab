...
4. Now you can add indexers in **Prowlarr**. My current setup is (most stolen from [torrentio](https://torrentio.strem.fun/):
    ...
    - **kickasstorrents.ws** priority = 9, tags = (movies, series, music, flaresolverr)
    - **NorTorrent** priority = 10, tags = (movies, series, music, flaresolverr)
    - **SubsPlease** priority = 11, tags = (movies, series)
...
7. To automatically add metadata go to `Settings` -> `Metadata`. Set **Tag Audio Files with Metadata** to **For new downloads only**.
